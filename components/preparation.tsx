...
import {
  AnimatedSchematicContext,
  animatedSchematicsInitialState,
  animatedSchematicsReducer,
} from '@/components/animated-schematic'
...
export function Preparation({
  ...
  const [animatedSchematicsState, dispatch] = useReducer(
    animatedSchematicsReducer,
    animatedSchematicsInitialState
  )

  return (
    <AnimatedSchematicContext.Provider
      value={useMemo(() => ({ animatedSchematicsState, dispatch }), [animatedSchematicsState])}
    >
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 mt-3 gap-6'>
            ...
            <div>
              <div className='flex items-center gap-2'>
                ...
                <p className='lg:text-lg font-bold border-b-4 border-green-900 grow pb-1'>
                  Healers:
                </p>
              </div>
              <ul className='mt-3 list-disc pl-4'>
