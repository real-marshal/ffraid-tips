...
<Preparation preparation={{
  all: ['Pick a clock spot', 'Choose EF1/3 baiting order', 'Choose EF2 strategy. If N/S, agree on MRRM/RMMR for DPS and THHT/HTTH for supports', 'Choose RB3 positions', 'Choose RB4 directions'],
  tanks: [],
  healers: [],
}} extraSections={[
  {
...
<TrivialMechs duty="ex4" mechs={{
  thornedCatharsis: {
    label: headings.trivial.items.thornedCatharsis,
    description: 'Unavoidable raid-wide damage.',
    strategy: 'Use damage reduction abilities.',
    type: 'healer',
    video: 'thorned_catharsis.webm'
  },
  stockBreak: {
    label: headings.trivial.items.specterOfTheLost,
    description: 'Tethered AoE tankbusters.',
    strategy: 'Let tanks pick up the tethers and move away from the party.',
    type: 'tank',
    video: 'specters_of_the_lost.webm'
  },
  specterOfTheLost: {
    label: headings.trivial.items.stockBreak,
    description: 'Multi-hit party stack.',
    strategy: 'Stack and use defensives.',
    type: 'healer',
    video: 'stock_break.webm'
  },
  perfumedQuietus: {
    label: headings.trivial.items.perfumedQuietus,
    description: 'Unavoidable raid-wide damage.',
    strategy: 'Use damage reduction abilities.',
    type: 'healer',
    video: 'perfumed_queietus.webm'
  },
  rb: {
    label: headings.trivial.items.rb,
    description: 'Arena change for the next RB phase.',
    strategy: 'Get ready for action.',
    video: 'roseblood_bloom.webm'
  }
}} />
...
<CoreMechVideo duty='ex4' filename='rb_4_emblazon.webm' note="If the reaper stood at the pictomancer's position instead, they could maintain full melee uptime, but it was too late. Fortunately, the DPS check is basically non-existent for this fight."/>
