...
<Preparation preparation={{
  all: ['Pick a clock spot', 'Choose Disco Infernal spotlight strategy (for melee classes only)', 'Choose Arcady Night Fever sides & safe spots', 'Choose alpha/beta debuff strategy', 'Choose Quarter Beats pairs'],
  tanks: [],
  healers: [],
}} extraSections={[
  {
...
<CoreMech>
  <CoreMechDesc>At some points in the fight, the boss casts *Flip to A-side* or *Flip to B-side*. This prepares delayed role or light party stacks that happen at some later time after a *2/3/4-snap Twist & Drop the Needle* cast.</CoreMechDesc>
  <CoreMechStrat>Remember: A - role, B - light party. Continue learning about other mechs to see when the boss does these preparation casts. It's important to pay attention to them, otherwise you won't know how to react to the next *2/3/4-snap Twist & Drop the Needle*. In a lot of parties, there's at least one person who uses macros to send which cast, A or B, the boss did, so that when *2/3/4-snap Twist & Drop the Needle* starts being casted people can just look at the chat to realize what to do.</CoreMechStrat>
</CoreMech>
...
<CoreMech>
  ...
  <CoreMechStrat>Recall whether this is supposed to be role or light party stacks. For role stacks, tanks move north, DPS - south, healers - center. For light party stacks, LP1 moves north, LP2 moves south, light parties are formed based on the [standard positions](#standard-clock-positions). Notice how M2 and R2 move south no matter what greatly reducing their mental burden during the fight.</CoreMechStrat>
</CoreMech>
